...
<head>
  ...
  <title>Dashboard - Editar Categoria</title>
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="text-center sidenav-header">
      ...
      <a class="navbar-brand m-0" href="../index.html">
        <span class="ms-1 font-weight-bold"><?php echo $_SESSION["empName"]; ?></span>
      </a>
    </div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Editar Categoria</h6>
        </nav>
    ...
    <form method="post" action="../actions/updateActions" enctype="multipart/form-data">
        ...
        <button type="submit" id="btnSubmit" name="submit" value="updateCategory" class="btn btn-primary btn-block mb-2">Salvar alterações</button>
      </form>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-2">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">Creative Tim</a> e
                <a href="https://github.com/lucasmch" class="font-weight-bold" target="_blank">Lucas Machado</a>.
              </div>
            </div>
          </div>
        </div>
